...
class _Home extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 228, 47, 131),
      body: Column(
        children: [
          Container(
            decoration: BoxDecoration(
              color: Color.fromARGB(255, 214, 145, 205),
            ),
            height: 180,
            child: Column(
                  ...
                  child: Align(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        shadows: [
                          Shadow(
                            color: Color.fromARGB(255, 223, 57, 153),
                            blurRadius: 6,
                ...
                suffixIcon: Container(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Color.fromARGB(255, 231, 96, 141),
